...
?>
<h2><?php echo __d('cake_dev', 'Release Notes for CakePHP %s.', '999999999'); ?></h2>
<p>
...
<ul>
	...
	<li><a href="https://testupload-uemura-php56.kyoto-dev.e-agency.co.jp/test"><?php echo __d('cake_dev', 'testPage'); ?> </a>
</ul>
